...
public abstract class DefaultConfigValue {
    ...
    public static void load(IConfigObject configObject) {
        configObject.register(GUILD_ID);
        configObject.register(WELCOME_MESSAGE);
        configObject.register(LEAVE_MESSAGE);
        configObject.register(WELCOME_MESSAGE_ENABLED);
        configObject.register(LEAVE_MESSAGE_ENABLED);
        configObject.register(WELCOME_LEAVE_MESSAGE_CHANNEL);
        configObject.update();
    }
